...
const subTitle = 'h6.fontSize'
const title = 'h5.fontSize'
  ...
  <React.Fragment>
    ...
    <Container maxWidth="lg">
      <Typography component="div">
        <Box sx={{ fontSize: subTitle, m: 2 }}>بِسْمِ ٱللَّٰهِ ٱلرَّحْمَٰنِ ٱلرَّحِيمِ</Box>
        <Box sx={{ fontSize: title, m: 2 }}>Privacy Policy</Box>
        <Box sx={{ m: 2 }}>
          Yūnus Andréasson built the OpenArabic app as a Free app. This SERVICE is provided by Yūnus Andréasson at no
          cost and is intended for use as is. This page is used to inform visitors regarding my policies with the
          collection, use, and disclosure of Personal Information if anyone decided to use my Service. If you choose to
          use my Service, then you agree to the collection and use of information in relation to this policy. The
          Personal Information that I collect is used for providing and improving the Service. I will not use or share
          your information with anyone except as described in this Privacy Policy. The terms used in this Privacy Policy
          have the same meanings as in our Terms and Conditions, which is accessible at OpenArabic unless otherwise
          defined in this Privacy Policy.
        </Box>
        <Box sx={{ fontSize: subTitle, m: 2 }}>Information Collection and Use</Box>
        <Box sx={{ m: 2 }}>
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Log Data</Box>
        <Box sx={{ m: 2 }}>
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Cookies</Box>
        <Box sx={{ m: 2 }}>
          Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These
          are sent to your browser from the websites that you visit and are stored on your devices internal memory. This
          Service does not use these “cookies” explicitly. However, the app may use third party code and libraries that
          use “cookies” to collect information and improve their services. You have the option to either accept or
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Service Providers</Box>
        <Box sx={{ m: 2 }}>
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Security</Box>
        <Box sx={{ m: 2 }}>
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Links to Other Sites</Box>
        <Box sx={{ m: 2 }}>
        ...
        <Box sx={{ fontSize: subTitle, m: 2 }}>Children’s Privacy</Box>
        <Box sx={{ m: 2 }}>
          ...
          are aware that your child has provided us with personal information, please contact me so that I will be able
          to do necessary actions.
        </Box>
        <Box sx={{ fontSize: subTitle, m: 2 }}>Changes to This Privacy Policy</Box>
        <Box sx={{ m: 2 }}>
          ...
          effective as of 2021-11-07.
        </Box>
        <Box sx={{ fontSize: subTitle, m: 2 }}>Contact Us</Box>
        <Box sx={{ m: 2 }}>
          If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at{' '}
          <Link href="mailto:">salam@edenmind.com</Link>.
        </Box>
      </Typography>
      <Footer />
    </Container>
