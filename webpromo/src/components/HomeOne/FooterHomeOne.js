                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="footer-about-widget">
                                ...
                                <p>Follow OpenArabic in Social Media for Daily Posts.</p>
                                {/* <a href="#">
                                ...
                                <div className="social mt-30">
                                    <ul>
                                        <li>
                                            <a href="https://www.facebook.com/OpenArabic.io/">
                                                <i className="fab fa-facebook-f" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://twitter.com/openarabicio">
                                                <i className="fab fa-twitter" />
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/openarabic.io/">
                        ...
                        {/* <div className="col-lg-3 col-md-6">
                            <div className="footer-widget-info">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            <i className="fal fa-envelope" /> salam@edenmind.com
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
